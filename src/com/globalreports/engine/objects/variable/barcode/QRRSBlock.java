...
public class QRRSBlock {
	...
	public static final int[][] RS_BLOCK_TABLE = new int[][] {
		// 1
		{1, 26, 19},
    	{1, 26, 16},
    	{1, 26, 13},
	...
	public static Vector<QRRSBlock> getRSBlocks(int typeNumber, int errorCorrectLevel) {
		int rsBlock[] = getRsBlockTable(typeNumber, errorCorrectLevel);
		
		if (rsBlock == null) {
			System.out.println("ERR: getRSBlocks");
			//throw new Error("bad rs block @ typeNumber:" + typeNumber + "/errorCorrectLevel:" + errorCorrectLevel);
		}

		int length = rsBlock.length / 3;
		
		Vector<QRRSBlock> list = new Vector<QRRSBlock>();
	...
	public static int[] getRsBlockTable(int typeNumber, int errorCorrectLevel) {
		...
		case QRCode.ERR_CORRECT_LEVEL_L :
			return QRRSBlock.RS_BLOCK_TABLE[(typeNumber - 1) * 4 + 0];
		case QRCode.ERR_CORRECT_LEVEL_M :
			return QRRSBlock.RS_BLOCK_TABLE[(typeNumber - 1) * 4 + 1];
		case QRCode.ERR_CORRECT_LEVEL_Q :
			return QRRSBlock.RS_BLOCK_TABLE[(typeNumber - 1) * 4 + 2];
		case QRCode.ERR_CORRECT_LEVEL_H :

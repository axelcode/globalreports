/*
 * ==========================================================================
 * class name  : com.globalreports.engine.io.GRPDFInputStream
 * 
 * Begin       : 
 * Last Update : 
 *
 ...
 * 
 */
package com.globalreports.engine.io;

public class GRPDFInputStream {
	public static final int EOF		= -1;
		
	private byte[] buffer;
	int pointer;
	
	public GRPDFInputStream(byte[] buff) {
		if(buff != null) {
